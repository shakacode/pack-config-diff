...
const WEBPACK_CONFIG_DOCS: Record<string, ConfigDoc> = {
  ...
  "output.publicPath": {
    ...
    documentationUrl: "https://webpack.js.org/configuration/output/#outputpublicpath",
  },
  "output.filename": {
    description: "Filename template for entry chunks. Can include [name], [hash], [contenthash].",
    affects: "Output filenames and cache busting strategy",
    documentationUrl: "https://webpack.js.org/configuration/output/#outputfilename",
  },
  "optimization.minimize": {
    ...
    documentationUrl: "https://webpack.js.org/configuration/optimization/#optimizationminimize",
  },
  "optimization.minimizer": {
    ...
    documentationUrl: "https://webpack.js.org/configuration/optimization/#optimizationminimizer",
  },
  "optimization.splitChunks": {
    description: "Code splitting configuration. Controls how chunks are split into separate files.",
    affects: "Bundle splitting, caching, and load performance",
    documentationUrl: "https://webpack.js.org/configuration/optimization/#optimizationsplitchunks",
  },
  "optimization.splitChunks.chunks": {
    ...
    documentationUrl: "https://webpack.js.org/plugins/split-chunks-plugin/#splitchunkschunks",
  },
  "optimization.splitChunks.maxSize": {
    ...
    documentationUrl: "https://webpack.js.org/plugins/split-chunks-plugin/#splitchunksmaxsize",
  },
  "cache.type": {
    description: "Type of caching: 'memory' (in-memory) or 'filesystem' (persistent disk cache).",
    affects: "Build speed on subsequent builds",
    documentationUrl: "https://webpack.js.org/configuration/cache/#cachetype",
  },
  "devServer.hot": {
    description: "Enable Hot Module Replacement (HMR) for live updates without full reload.",
    defaultValue: "true",
    affects: "Development experience and reload behavior",
    documentationUrl: "https://webpack.js.org/configuration/dev-server/#devserverhot",
  },
  "devServer.port": {
    description: "Port number for the webpack dev server.",
    defaultValue: "8080",
    affects: "URL where dev server is accessible",
    documentationUrl: "https://webpack.js.org/configuration/dev-server/#devserverport",
  },
  target: {
    description: "Deployment target environment: 'web', 'node', 'electron-main', etc.",
    defaultValue: "'web'",
  ...
  entry: {
    ...
    documentationUrl: "https://webpack.js.org/configuration/entry-context/#entry",
  },
  resolve: {
  ...
  "resolve.extensions": {
    description: "File extensions to try when resolving modules (e.g., ['.js', '.jsx']).",
    defaultValue: "['.js', '.json', '.wasm']",
    affects: "Which files can be imported without extensions",
    documentationUrl: "https://webpack.js.org/configuration/resolve/#resolveextensions",
  },
  module: {
  ...
  "module.rules": {
    description: "Array of rules for processing different file types with loaders.",
  ...
  externals: {
    description: "Dependencies to exclude from bundles (assumed to be available at runtime).",
