...
describe("BuildConfigFileLoader", () => {
  ...
  describe("exists", () => {
    ...
    test("returns false when file does not exist", () => {
      const loader = new BuildConfigFileLoader(path.join(tempDir, "nonexistent.yml"));
  ...
  describe("load", () => {
    ...
    test("throws when file does not exist", () => {
      const loader = new BuildConfigFileLoader(path.join(tempDir, "missing.yml"));
  ...
  describe("validation", () => {
    ...
    test("rejects build without config field", () => {
      const filePath = writeConfig("no-config.yml", "builds:\n  dev:\n    bundler: webpack\n");
      const loader = new BuildConfigFileLoader(filePath);
  ...
  describe("resolveBuild", () => {
    ...
    test("throws for unknown build name", () => {
      ...
      expect(() => loader.resolveBuild("nonexistent")).toThrow("Build 'nonexistent' not found");
    });
